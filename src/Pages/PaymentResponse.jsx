...
function PaymentResponse() {
  ...
  useEffect(() => {
    ...
    dispatch(getTransactionById(newCollection.preference_id));
    setCollection(newCollection);
  }, [searchParams]);

  useEffect(() => {
    setNewDataTransaction({ ...transaction, status: collection?.status });
    if (newDataTransaction.preference_id)
      dispatch(updateTransaction(newDataTransaction));
  }, [transaction, collection?.status, newDataTransaction.preference_id]);
